...
#define PIXEL1600_10    *dp = Interp1_16(w[5], w[1]);
#define PIXEL1600_11    *dp = Interp1_16(w[5], w[4]);
#define PIXEL1600_12    *dp = Interp1_16(w[5], w[2]);
#define PIXEL1600_20    *dp = Interp2_16(w[5], w[4], w[2]);
#define PIXEL1600_21    *dp = Interp2_16(w[5], w[1], w[2]);
#define PIXEL1600_22    *dp = Interp2_16(w[5], w[1], w[4]);
#define PIXEL1600_60    *dp = Interp6_16(w[5], w[2], w[4]);
#define PIXEL1600_61    *dp = Interp6_16(w[5], w[4], w[2]);
#define PIXEL1600_70    *dp = Interp7_16(w[5], w[4], w[2]);
#define PIXEL1600_90    *dp = Interp9_16(w[5], w[4], w[2]);
#define PIXEL1600_100   *dp = Interp10_16(w[5], w[4], w[2]);
#define PIXEL1601_0     *(dp+1) = w[5];
#define PIXEL1601_10    *(dp+1) = Interp1_16(w[5], w[3]);
#define PIXEL1601_11    *(dp+1) = Interp1_16(w[5], w[2]);
#define PIXEL1601_12    *(dp+1) = Interp1_16(w[5], w[6]);
#define PIXEL1601_20    *(dp+1) = Interp2_16(w[5], w[2], w[6]);
#define PIXEL1601_21    *(dp+1) = Interp2_16(w[5], w[3], w[6]);
#define PIXEL1601_22    *(dp+1) = Interp2_16(w[5], w[3], w[2]);
#define PIXEL1601_60    *(dp+1) = Interp6_16(w[5], w[6], w[2]);
#define PIXEL1601_61    *(dp+1) = Interp6_16(w[5], w[2], w[6]);
#define PIXEL1601_70    *(dp+1) = Interp7_16(w[5], w[2], w[6]);
#define PIXEL1601_90    *(dp+1) = Interp9_16(w[5], w[2], w[6]);
#define PIXEL1601_100   *(dp+1) = Interp10_16(w[5], w[2], w[6]);
#define PIXEL1610_0     *(dp+dpL) = w[5];
#define PIXEL1610_10    *(dp+dpL) = Interp1_16(w[5], w[7]);
#define PIXEL1610_11    *(dp+dpL) = Interp1_16(w[5], w[8]);
#define PIXEL1610_12    *(dp+dpL) = Interp1_16(w[5], w[4]);
#define PIXEL1610_20    *(dp+dpL) = Interp2_16(w[5], w[8], w[4]);
#define PIXEL1610_21    *(dp+dpL) = Interp2_16(w[5], w[7], w[4]);
#define PIXEL1610_22    *(dp+dpL) = Interp2_16(w[5], w[7], w[8]);
#define PIXEL1610_60    *(dp+dpL) = Interp6_16(w[5], w[4], w[8]);
#define PIXEL1610_61    *(dp+dpL) = Interp6_16(w[5], w[8], w[4]);
#define PIXEL1610_70    *(dp+dpL) = Interp7_16(w[5], w[8], w[4]);
#define PIXEL1610_90    *(dp+dpL) = Interp9_16(w[5], w[8], w[4]);
#define PIXEL1610_100   *(dp+dpL) = Interp10_16(w[5], w[8], w[4]);
#define PIXEL1611_0     *(dp+dpL+1) = w[5];
#define PIXEL1611_10    *(dp+dpL+1) = Interp1_16(w[5], w[9]);
#define PIXEL1611_11    *(dp+dpL+1) = Interp1_16(w[5], w[6]);
#define PIXEL1611_12    *(dp+dpL+1) = Interp1_16(w[5], w[8]);
#define PIXEL1611_20    *(dp+dpL+1) = Interp2_16(w[5], w[6], w[8]);
#define PIXEL1611_21    *(dp+dpL+1) = Interp2_16(w[5], w[9], w[8]);
#define PIXEL1611_22    *(dp+dpL+1) = Interp2_16(w[5], w[9], w[6]);
#define PIXEL1611_60    *(dp+dpL+1) = Interp6_16(w[5], w[8], w[6]);
#define PIXEL1611_61    *(dp+dpL+1) = Interp6_16(w[5], w[6], w[8]);
#define PIXEL1611_70    *(dp+dpL+1) = Interp7_16(w[5], w[6], w[8]);
#define PIXEL1611_90    *(dp+dpL+1) = Interp9_16(w[5], w[6], w[8]);
#define PIXEL1611_100   *(dp+dpL+1) = Interp10_16(w[5], w[6], w[8]);

HQX_API void HQX_CALLCONV hq2x_16_rb( uint16_t * sp, uint32_t srb, uint16_t * dp, uint32_t drb, int Xres, int Yres )
{
    int  i, j, k;
    int  prevline, nextline;
    uint16_t  w[10];
...
HQX_API void HQX_CALLCONV hq2x_16( uint16_t * sp, uint16_t * dp, int Xres, int Yres )
{
